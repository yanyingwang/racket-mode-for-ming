...
(define (to-ming lst)
  (map (lambda (e) (symbol->string (second e)))
       (filter (lambda (e)
                 (member (symbol->string (car e)) lst))
               ming-data))
  )


(define opfile "racket-keywords-and-builtins.el")
